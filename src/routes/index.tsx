...
import {
  ...
  BarChart3, FileSpreadsheet, Table, Monitor,
} from "lucide-react";
...
const PROJECTS = [
  {
    ...
    desc: "I conducted a comprehensive analysis of 500 South Indian colleges by collecting and organizing data such as college rankings, locations, courses offered, fee structures, placement records, infrastructure, and student reviews. Using Microsoft Excel, I cleaned, structured, and managed the dataset to ensure data accuracy and consistency. With Jupyter Notebook and Python libraries like Pandas and Matplotlib, I performed data preprocessing, exploratory data analysis, and trend identification to uncover patterns in placements, fees, and academic performance. Finally, I used Microsoft Power BI to create interactive dashboards and visualizations, making it easier to compare institutions and derive meaningful insights for students and stakeholders.",
    highlights: [
      "Analyzed 500+ college datasets across South India",
      "Cleaned and processed data using Excel and Python (Pandas)",
      "Built data visualizations and trend analysis in Jupyter Notebook",
      "Developed interactive dashboards in Power BI for decision-making",
      "Identified patterns in rankings, fees, placements, and course popularity",
    ],
  ...
  },
  {
    ...
    tag: "Cloud · AWS · Deployment",
    desc: "The AWS One-Click Application Deployment Platform is a web-based system that enables developers to deploy applications to AWS infrastructure without manually configuring servers, installing software packages, or performing deployment operations. The platform automates the creation and configuration of AWS EC2 instances and deploys applications using predefined deployment templates, streamlining the entire DevOps workflow.",
    highlights: [
      "Automated AWS EC2 instance creation and configuration",
      "Predefined deployment templates for rapid application rollout",
      "Eliminated manual server setup and software installation",
      "Streamlined end-to-end cloud deployment workflow",
    ],
    stack: ["AWS EC2", "Cloud Deployment", "System Design", "Documentation"],
    icon: Cloud,
  },
  {
    title: "UI/UX Web Page Design",
    tag: "Frontend · Design · User Experience",
    desc: "Designed web page user interfaces that are user-friendly and attractive, leading to better reach and audience engagement for the application/website. Focused on responsive layouts, intuitive navigation, and visually appealing components to ensure a seamless user experience across all devices.",
    highlights: [
      "Created user-friendly and visually attractive web interfaces",
      "Improved audience reach and engagement through design",
      "Built responsive layouts for seamless cross-device experience",
      "Focused on intuitive navigation and modern UI patterns",
    ],
    stack: ["HTML", "CSS", "Responsive Design", "UI/UX"],
    icon: Monitor,
  },
];
